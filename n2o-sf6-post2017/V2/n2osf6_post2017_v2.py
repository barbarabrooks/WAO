...
import pandas as pd
import numpy as np
import n2osf6_post2017_parser_v2 as onp
import n2osf6_post2017_NC_v2 as nc

data = namedtuple("data", "DT DoY ET sf6 flag")
...
#save nc file
nc.NC_n2osf6_post2017_v2(pd, np, dout, meta, data)