def coh2_create_NC_file_v2(dout, DT):
   ...
   f4 = 'h2-concentration' #data product
...
def coh2_NC_VaraiblesAndData_v2(fn_nc, data, np, lat, lon):
   ...
   qc_flags.flag_meanings = qc_flags.flag_meanings + 'suspect_data_data_not_quality_controlled' + '\n'
   qc_flags.flag_meanings = qc_flags.flag_meanings + 'bad_data_do_not_use' 
   #write data
   qc_flags[:] = np.int8(data.flag)
   
def NC_coh2_post2017_v2(pd, np, dout, meta, data):
